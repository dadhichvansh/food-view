...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: `Welcome to FoodieHub! Redirecting to ${
          ...
          <CardContent>
            ...
            >
              <div className="space-y-2">
                <Label htmlFor="name">
                  {isPartner ? 'Owner Name' : 'Full Name'}
                </Label>
                <Input
                  id="name"
                  name="name"
                  type="text"
                  placeholder={
                    isPartner ? 'Enter owner name' : 'Enter your full name'
                  }
                  value={formData.name}
