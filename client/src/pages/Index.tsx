...
import { MapPin, Search, Star, Clock, Truck, ChefHat, Smartphone, Users } from "lucide-react";
import { Link } from "react-router-dom";
import heroImage from "@/assets/hero-food.jpg";

const Index = () => {
  const features = [
    { icon: Truck, title: "Fast Delivery", description: "Get your food in 30 minutes or less" },
    { icon: ChefHat, title: "Quality Food", description: "From the best restaurants in town" },
    { icon: Smartphone, title: "Easy Ordering", description: "Order with just a few taps" },
    { icon: Users, title: "Join as Partner", description: "Grow your restaurant business with us" }
  ];
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center animate-bounce-in">
              <Link to="/dashboard">
                <Button size="lg" className="bg-gradient-primary text-primary-foreground hover:opacity-90 transition-opacity px-8">
                  Order Now
                </Button>
              </Link>
              <Link to="/reels">
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Experience the best food delivery service in your city</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="text-center border-0 shadow-food bg-gradient-card hover:shadow-lg transition-shadow">
      ...
      <section className="py-20 bg-gradient-hero relative overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who trust FoodieHub for their daily meals
          </p>
      ...
      <footer className="bg-card border-t py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-muted-foreground">&copy; 2024 FoodieHub. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
